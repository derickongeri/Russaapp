...
export const useMetaStore = defineStore("usermeta", {
  state: () => {
    const { t } = useI18n();
    ...
    return {
      ...
      userSigns: [{ id: 1, label: t("signs.abdominal_pain") }],
    };
  },
  ...
  actions: {
    addPhysicalInfo(val) {
      console.log(val);
      this.physicalInfo = val;
    },
    addMenopauseStatus(val) {
      console.log(val);
      this.menopauseStatus = val;
    },
    addHealthCondition(val) {
      console.log(val);
      this.healthConditions = val;
    },
